...
<header class="navigation fixed-top">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand font-tertiary h3" href="index.html"><img src="<?php echo base_url(); ?>assets/images/logo_proplan.png" alt="Myself"></a>
            ...
            <div class="col-lg-12 text-center">
                <div class="card shadow text-center">
                    <div class="card-footer bg-white">
                        <img src="assets/images/02.png" alt="bg-shape">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 mb-80">
                <div>
                    <img src="assets/images/01.png" alt="bg-shape">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 mb-80">
                <div class="d-flex">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mx-auto">
                <div class="bg-white rounded text-center p-5 shadow-down">
                    ...
                    <form action="<?php echo base_url(); ?>contact/insert" method="post" class="row">
                        <div class="col-md-6">
              ...
              <textarea name="message" id="message" class="form-control px-0 mb-4"
                        ...
                        <div class="col-lg-6 col-10 mx-auto">
                            <button type="submit0 " class="btn btn-primary w-100">Envoyer</button>
                        </div>
                    </form>
                </div>
            </div>
