    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4" >
            <div class="panel panel-default" style="background-color:#FFFFFF ;height: 400px;margin-top: 100px;border-radius: 3%;box-shadow: -8px 9px 11px -5px rgba(0,0,0,0.75);">
                <div class="panel-body">
                    <center>
                        <img src="<?php echo base_url(); ?>assets/img/security.png" style="width: 90px ; height: auto ; margin-top: 20px;">
                        <h4 style="text-align: center ; color: green">bienvenue dans notre PlanPro communautaire!</h4>
                        <p style="text-align: center ;font-size: 16px;margin-top: 15px">
                            Votre courriel a été vérifié avec succès, vous pouvez maintenant vous connecter à partir de :
                        </p>
                        <button class="btn"style="padding: 9px 12px;
                                        padding-top: 7px;
                                        font-size: 14px;
                                        line-height: 20px;
                                        color: #FFFFFF;
                            ...
                            <a href="<?php echo base_url(); ?>login" style="text-decoration: none;color: #FFFFFF">Identifier</a></button>
                    </center>
                </div>
            </div>
        </div>
        ...
        <!-- <div class="col-md-offset-4 col-md-4" style="background-color:#FFFFFF ;height: 400px;margin-top: 100px;border-radius: 3%;box-shadow: -8px 9px 11px -5px rgba(0,0,0,0.75);">
                   <div class="col-md-offset-4 col-md-4" >
                       <img src="<?php echo base_url(); ?>assets/img/error.png" style="width: 90px ; height: auto ; margin-top: 20px;">
                   </div>
