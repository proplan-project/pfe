<?php echo form_open('equipe/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="titre_emploi" value="<?php echo $this->input->post('titre_emploi'); ?>" class="form-control" id="titre_emploi" />
