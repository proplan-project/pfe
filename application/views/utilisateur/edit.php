<?php echo form_open('utilisateur/edit/'.$utilisateur['id_utilisateur'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="is_admin" class="col-md-4 control-label"><span class="text-danger">*</span>Is Admin</label>
		<div class="col-md-8">
			<input type="checkbox" name="is_admin" value="1" <?php echo ($utilisateur['is_admin']==1 ? 'checked="checked"' : ''); ?> id='is_admin' />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_createur" class="form-control">
				...
				{
					$selected = ($utilisateur['id_utilisateur'] == $utilisateur['id_createur']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="type" value="<?php echo ($this->input->post('type') ? $this->input->post('type') : $utilisateur['type']); ?>" class="form-control" id="type" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="tel" value="<?php echo ($this->input->post('tel') ? $this->input->post('tel') : $utilisateur['tel']); ?>" class="form-control" id="tel" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="genre" value="<?php echo ($this->input->post('genre') ? $this->input->post('genre') : $utilisateur['genre']); ?>" class="form-control" id="genre" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="date_creation" value="<?php echo ($this->input->post('date_creation') ? $this->input->post('date_creation') : $utilisateur['date_creation']); ?>" class="form-control" id="date_creation" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="image" class="form-control" id="image"><?php echo ($this->input->post('image') ? $this->input->post('image') : $utilisateur['image']); ?></textarea>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="adresse" class="form-control" id="adresse"><?php echo ($this->input->post('adresse') ? $this->input->post('adresse') : $utilisateur['adresse']); ?></textarea>
