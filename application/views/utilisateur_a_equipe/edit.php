<?php echo form_open('utilisateur_a_equipe/edit/'.$utilisateur_a_equipe[''],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_utilisateur" class="form-control">
				...
				{
					$selected = ($utilisateur['id_utilisateur'] == $utilisateur_a_equipe['id_utilisateur']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_equipe" class="form-control">
				...
				{
					$selected = ($equipe['id_equipe'] == $utilisateur_a_equipe['id_equipe']) ? ' selected="selected"' : "";
