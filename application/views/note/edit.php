<?php echo form_open('note/edit/'.$note['id_note'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_projet" class="form-control">
				...
				{
					$selected = ($projet['id_projet'] == $note['id_projet']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_createur" class="form-control">
				...
				{
					$selected = ($utilisateur['id_utilisateur'] == $note['id_createur']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="titre" value="<?php echo ($this->input->post('titre') ? $this->input->post('titre') : $note['titre']); ?>" class="form-control" id="titre" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="date_creation" value="<?php echo ($this->input->post('date_creation') ? $this->input->post('date_creation') : $note['date_creation']); ?>" class="form-control" id="date_creation" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="description" class="form-control" id="description"><?php echo ($this->input->post('description') ? $this->input->post('description') : $note['description']); ?></textarea>
