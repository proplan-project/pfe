<?php echo form_open('client/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="nom_entreprise" value="<?php echo $this->input->post('nom_entreprise'); ?>" class="form-control" id="nom_entreprise" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="site" value="<?php echo $this->input->post('site'); ?>" class="form-control" id="site" />
