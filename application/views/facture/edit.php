<?php echo form_open('facture/edit/'.$facture['id_facture'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_projet" class="form-control">
				...
				{
					$selected = ($projet['id_projet'] == $facture['id_projet']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_client" class="form-control">
				...
				{
					$selected = ($client['id_client'] == $facture['id_client']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="date_facture" value="<?php echo ($this->input->post('date_facture') ? $this->input->post('date_facture') : $facture['date_facture']); ?>" class="form-control" id="date_facture" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="date_echeance" value="<?php echo ($this->input->post('date_echeance') ? $this->input->post('date_echeance') : $facture['date_echeance']); ?>" class="form-control" id="date_echeance" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="montant" value="<?php echo ($this->input->post('montant') ? $this->input->post('montant') : $facture['montant']); ?>" class="form-control" id="montant" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="paiement_recu" value="<?php echo ($this->input->post('paiement_recu') ? $this->input->post('paiement_recu') : $facture['paiement_recu']); ?>" class="form-control" id="paiement_recu" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="status" value="<?php echo ($this->input->post('status') ? $this->input->post('status') : $facture['status']); ?>" class="form-control" id="status" />
